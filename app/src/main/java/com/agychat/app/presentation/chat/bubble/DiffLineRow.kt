...
import com.agychat.app.domain.model.DiffLineType
...
fun DiffLineRow(line: DiffLine) {
    ...
    Row(
        ...
        Text(text = line.lineNumber.toString(), modifier = Modifier.width(32.dp), color = Color.Gray, fontFamily = FontFamily.Monospace)
